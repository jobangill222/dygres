...
const Post = () => {
    ...
    const { postList, popupType, setPostList, getOtherUserPostsByUserIDDContext, postIDForAwardOfPost, isLoading, setIsLoading, getOtherUserDetailByUserIDDContext } = useContext(DContext);
